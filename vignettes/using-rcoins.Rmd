...
![plot of chunk plot-streets](figures/using-rcoins-plot-streets-1.png)
...
![plot of chunk plot-continuous-streets](figures/using-rcoins-plot-continuous-streets-1.png)
